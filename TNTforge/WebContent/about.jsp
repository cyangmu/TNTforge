								...
								<ul class="header-top-style">
									<li id="loged"><a href="login.jsp"> <span>Login or
										...
										<div class="ul-style login-register box-shadow white-bg p-30">
											...
											<h6>
												<a href="login.jsp"> <strong class="mb-20">or
														register to</strong></a>
											</h6>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="about-top-text">
								<h4 class="about-title mb-35">
									<span class="text-defualt">FORGE</span> THE LARGEST COLLECTION
									FOR YOU
								</h4>
								<p>ge is the best online shop for your online shopping orem
									ipsum dolor sit amet, consectetur adipiscing elit,</p>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
									sed do eiusmod tempor incididunt ut labore et dolore magna
									aliqua. Ut enim ad minim nia, quis nostrud exercitation ullamco
									laboris nisi ut aliquip ex ea comm.</p>
								<p class="display-none">Lorem ipsum dolor sit amet,
									consectetur adipiscing elit, sed do eiusmod tempor incididunt
									ut labore et dolore magna aliqua. Ut enim ad minim</p>
								<div class="signature">
									<img alt="" src="images/about/signature.png">
									<h6>
										<a href="#">Arizona Smith</a>
									</h6>
						...
						<div class="col-sm-6">
							...
							<div class="about-middle-inner">
								...
								<div class="about-middle-content">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
										sed do eiusm jedo tempor incididunt ut labore et dolore magna
										aliqua. Ut enim ad inim veniam, quis nostrud exercitation
										ullamco laboris nisi ut aliquiLorem</p>
									<ul class="mission-list">
										<li><img alt="" src="images/about/check.png">
								...
								<div class="news-to-blog display-none">
									...
									<div class="about-middle-content">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing
											elit, sed do eiusm jedo tempor incididunt ut labore et dolore
											magna aliqua. Ut enim ad inim veniam, quis nostrud
											exercitation ullamco laboris nisi ut aliquiLorem</p>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing
											elit, sed do eiusm jedo tempor incididunt ut labore et dolore
											magna aliqua. Ut enim ad inim veniam, quis nostrud
											exercitation ullamco laboris nisi ut aliquiLorem</p>
							...
							<ul class="about-icon-list">
								<li class="about-single-icon mb-50">
									...
									<div class="choose-content pl-70">
										<h5 class="text-defualt mb-20 text-uppercase">
