                        ...
                        <div class="col-md-offset-0 col-md-5 col-sm-offset-0 col-sm-4 col-xs-offset-3 col-xs-6">
                            <div class="shopping-cart">
                                <a href="#">
                                    ...
                                    <a href="shoppingcarts.jsp"><span class="cart-size-value"><strong>Shopping<br>Carts(<span id="count">
            	...
            	<br>
			 	...
			 	<table class="table table-striped table-bordered table-hover">
			 		...
			 		for(int i=0;i<goodKind;i++){
				 	    ...
				 	    String des = price.checkGoodde(goodName[i]);
				 	    int p=Integer.parseInt(good);
			 		%>
			 		<tbody>
			 			<tr id="goodCart">
				 			<td ><%out.print(i+1);%></td>
				 			<td><%out.print(goodName[i]);%></td>
				 			<td><%out.print(des); %></td>
				 			<td>$<span ><%out.print(p); %></span></td>
				 			<td><input type="button" value="-" class="reduce">
								<input type="text" value="<%out.print(goodNum[i]);%>" name="num" class="quantity">
								<input type="button" value="+" class="add">
								<button type="button" class="btn btn-default" value="delete">Delete</button>
				 			</td>
				 			<td>$<span class="toalprie"><%out.print(goodNum[i]*p); %></span></td>
			 			</tr>
				 		<%}}%>
			 		</tbody>
			 	</table>
			 	<div class="shopingcarts_total">Payment:$<span>0</span><br /></div>
			 	<br><br /><br />
			 	<button type="button" class="btn btn-primary"><a href="shop.jsp">View Likes</a></button>
			 	<span style="margin: 0 20px;"></span>
			 	<button type="button" class="btn btn-primary"><a href="orderDetail.jsp">Check Out</a></button>
		 	</div>
