...
<script src="js/cartup.js"></script>
		...
		$.ajax({
			...
			success:function(result){
				...
				for(var i=0;i<rst.length;i++){
					msg+="<span class='t1'>"+rst[i]+"</span><br>";
				}}
				$("#s").show();
				$("#s").html(msg);
					...
					<div class="row">
						...
						<div class="col-sm-4 col-xs-6">
							<div class="header-top-right">
								<span class="mr-20"><a href="detail.jsp"><img alt=""
										src="images/header/search-icon.png"></a></span> <span>
										<input id="search"type="text" class="pl-10" placeholder="Search..."></span>
									<div id="s" style="z-index:99999;background-color:black;display:none;width:142px;position:absolute;left:228px;color:#FFFFFF"></div>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="product-container cp-style-2">
								<div class="product-inner">
									...
									<ul class="quick-veiw text-center">
										<li class="opk"><a><i class="fa fa-shopping-cart"></i></a></li>
	...
	$(function(){
		...
		$("#logintwo").click(function() {
			$.get("LoginTwoServlet", {
				...
				var ustate = result.substring(result.length-3, result.length);
